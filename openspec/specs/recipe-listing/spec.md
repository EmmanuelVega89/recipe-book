...
El sistema SHALL mostrar todas las recetas en un grid responsive de cards. El grid MUST usar 1 columna en mobile, 2 en tablet y 3 en desktop.

#### Scenario: Renderizado del grid con recetas
- **WHEN** las recetas se obtienen exitosamente de la API
- **THEN** se renderiza una card por cada receta en un layout grid responsive
